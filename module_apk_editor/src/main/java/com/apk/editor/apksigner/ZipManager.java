...
import com.apk.editor.utils.IOUtils;
...
public class ZipManager {
     ...
     * @throws IOException
     */
    public static void deleteZipEntry3(File zipFile, String[] suffixs) {
...
//            FileUtils.copyFile(zipFile, tempFile);
            Files.copy(Paths.get(zipFile.getAbsolutePath()), Paths.get(tempFile.getAbsolutePath()));
