...
public class StringBlock implements IAXMLSerialize {
    ...
    public String toString() {
        return "StringBlock{" + "mChunkSize=" + mChunkSize + ", mStringsCount=" + mStringsCount + ", mStylesCount=" + mStylesCount + ", mEncoder=" + mEncoder + ", mStrBlockOffset=" + mStrBlockOffset + ", mStyBlockOffset=" + mStyBlockOffset + ", mPerStrOffset=" + Arrays.toString(mPerStrOffset) + ", mPerStyOffset=" + Arrays.toString(mPerStyOffset) + ", mStrings=" + mStrings + ", mStyles=" + mStyles + '}';
    }
