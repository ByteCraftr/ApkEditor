...
public class ReValueEditor extends BaseEditor<ReValueEditor.EditorInfo> {
    ...
    public ReValueEditor(AXMLDoc doc, String nodeName, String attrName) {
        super(doc);
    ...
    protected void editor() {
        ...
        System.out.println("replace : " + editorInfo.getValue());
