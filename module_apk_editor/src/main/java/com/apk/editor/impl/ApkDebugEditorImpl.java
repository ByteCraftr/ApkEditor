...
public class ApkDebugEditorImpl implements ApkEditor {
    ...
    public ApkDebugEditorImpl(ApkDataLoad apkDataLoad) {
    ...
    private boolean generationNewApk(CApkInfo mCApkInfo, SignInfo signInfo) {
        ...
        try {
            ApkDebugControl apkControl = new ApkDebugControl(mCApkInfo, signInfo);
